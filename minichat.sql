...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 26 sep. 2019 à 02:35
...
(1, 'Ma premières niouz', 'This is my first niouz !'),
(2, '2em niouZ', 'Et voici la deuxieme, on s\'arrete pu');
...
INSERT INTO `visiteurs` (`id`, `username`, `age`, `email`) VALUES
(1, 'Jean Michel', 66, 'jeanmi@gmail.com'),
(2, 'Nadège', 45, 'nadege13@gmail.com');
COMMIT;
